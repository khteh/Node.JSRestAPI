...
export class RegisterRequest extends jspb.Message { 
    ...
    setTeachersList(value: Array<teacher_pb.Teacher>): RegisterRequest;
    ...
    setStudentsList(value: Array<student_pb.Student>): RegisterRequest;
...
export class AddStudentsToTeacherRequest extends jspb.Message { 
    ...
    setTeacher(value?: teacher_pb.Teacher): AddStudentsToTeacherRequest;
    clearStudentsList(): void;
    getStudentsList(): Array<string>;
    setStudentsList(value: Array<string>): AddStudentsToTeacherRequest;
...
export class CommonStudentsRequest extends jspb.Message { 
    ...
    setTeachersList(value: Array<string>): CommonStudentsRequest;
...
export class CommonStudentsResponse extends jspb.Message { 
    clearStudentsList(): void;
    getStudentsList(): Array<student_pb.Student>;
    setStudentsList(value: Array<student_pb.Student>): CommonStudentsResponse;
    addStudents(value?: student_pb.Student, index?: number): student_pb.Student;

    hasResponse(): boolean;
    clearResponse(): void;
    getResponse(): response_pb.Response | undefined;
    setResponse(value?: response_pb.Response): CommonStudentsResponse;
