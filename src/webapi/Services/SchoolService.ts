...
import { RegisterRequest } from "../grpc/client/school_pb.js";
...
import { SchoolService, ISchoolServer } from "../grpc/client/school_grpc_pb.js";
...
class ServerImpl implements ISchoolServer {
     ...
     */
    public async register (call: grpc.ServerUnaryCall<RegisterRequest, Response>, callback: grpc.sendUnaryData<Response>) {
    ...
    public async addStudentsToTeacher (call: grpc.ServerUnaryCall<grpcAddStudentsToTeacherRequest, Response>, callback: grpc.sendUnaryData<Response>) {
        const request = call.request;
        try {
            let message: string = "";
            let errors: Array<Error> = [];
    ...
    public async commonStudents (call: grpc.ServerUnaryCall<grpcCommonStudentsRequest, CommonStudentsResponse>, callback: grpc.sendUnaryData<CommonStudentsResponse>) {
        const request = call.request;
        try {
            let message: string = "";
            let errors: Array<Error> = [];
...
export function getServer () {
    ...
    server.addService(SchoolService, new ServerImpl());
    /* {
        register,
